...
function _createInput(className, config){
	var input = config && config.textarea ? document.createElement("textarea") : document.createElement("input");
	input.setAttribute("class",className);
	if( config && config.placeholder) input.setAttribute("placeholder", config.placeholder)
	if( config && config.id) input.setAttribute("id", config.id)
	if( config && config.onClick ) input.onclick = config.onClick
